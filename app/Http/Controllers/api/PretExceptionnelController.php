...
use App\Models\Pret;
use App\Services\PretExceptionnelService;
use Illuminate\Http\Request;

class PretExceptionnelController extends Controller
{
    public function __construct(private PretExceptionnelService $service) {}
